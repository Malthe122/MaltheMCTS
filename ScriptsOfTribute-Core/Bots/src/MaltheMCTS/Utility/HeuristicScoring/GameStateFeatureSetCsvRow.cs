...
namespace SimpleBots.src.MaltheMCTS.Utility.HeuristicScoring
{
    ...
    public class GameStateFeatureSetCsvRow
    {
        ...
        [LoadColumn(10)] public float CurrentPlayerAgent_PrestigeStrength { get; set; }
        [LoadColumn(11)] public float CurrentPlayerAgent_PowerStrength { get; set; }
        [LoadColumn(12)] public float CurrentPlayerAgent_GoldStrength { get; set; }
        [LoadColumn(13)] public float CurrentPlayerAgent_MiscStrength { get; set; }
        [LoadColumn(14)] public float CurrentPlayerPatronFavour { get; set; }
        [LoadColumn(15)] public float OpponentPrestige { get; set; }
        [LoadColumn(16)] public float OpponentDeck_PrestigeStrength { get; set; }
        [LoadColumn(17)] public float OpponentDeck_PowerStrength { get; set; }
        [LoadColumn(18)] public float OpponentDeck_GoldStrength { get; set; }
        [LoadColumn(19)] public float OpponentDeck_MiscStrength { get; set; }
        [LoadColumn(20)] public float OpponentAgent_PrestigeStrength { get; set; }
        [LoadColumn(21)] public float OpponentAgent_PowerStrength { get; set; }
        [LoadColumn(22)] public float OpponentAgent_GoldStrength { get; set; }
        [LoadColumn(23)] public float OpponentAgent_MiscStrength { get; set; }
        [LoadColumn(24)] public float OpponentPatronFavour { get; set; }
